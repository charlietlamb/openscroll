...
export const isRecencyFilter = (
  config: FilterConfig
): config is RecencyFilterConfig => config.key === "recency";

export const isMetricFilter = (
  config: FilterConfig
): config is MetricFilterConfig => config.key !== "recency";
